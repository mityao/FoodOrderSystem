...
import com.willyao.android.foodordersystem.cartPage.fragments.CheckFragment;
...
import static com.willyao.android.foodordersystem.R.id.map;
...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBtn = (ImageView) findViewById(R.id.map_btn_set);
        ...
        setBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    CheckFragment.mTextAddress.setText(address);
                }catch (Exception e){
    ...
    private void updateMapView(double lat, double lng){
        ...
        mMap.addMarker(new MarkerOptions().position(setLocation).title("Deliver to this Address")
                .snippet(etAddress.getText().toString().trim())
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.locate)));
